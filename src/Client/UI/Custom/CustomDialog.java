...
public class CustomDialog extends CustomWindow{
		...
		focusListener = new FocusListener() {
			...
			private void focusChanged (FocusEvent event) {
				...
				if (isModal && stage != null && stage.getRoot().getChildren().size > 0
					&& stage.getRoot().getChildren().peek() == CustomDialog.this) { // Dialog is top most actor.
					Actor newFocusedActor = event.getRelatedActor();
					if (newFocusedActor != null && !newFocusedActor.isDescendantOf(CustomDialog.this) &&
	...
	public CustomDialog text (String text, LabelStyle labelStyle) {
		return text(new Label(text, labelStyle));
	}

	/** Adds the given Label to the content table */
	public CustomDialog text (Label label) {
	...
	public CustomDialog button (String text) {
	...
	public CustomDialog button (String text, Object object) {
		if (skin == null)
			throw new IllegalStateException("This method may only be used if the dialog was constructed with a Skin.");
	 ...
	 * @param object The object that will be passed to {@link #result(Object)} if this button is clicked. May be null. */
	public CustomDialog button (String text, Object object, TextButtonStyle buttonStyle) {
		return button(new TextButton(text, buttonStyle), object);
	}

	/** Adds the given button to the button table. */
	public CustomDialog button (Button button) {
		return button(button, null);
	}

	/** Adds the given button to the button table.
	 * @param object The object that will be passed to {@link #result(Object)} if this button is clicked. May be null. */
	public CustomDialog button (Button button, Object object) {
	...
	public CustomDialog show (Stage stage, Action action) {
		clearActions();
	...
	public CustomDialog show (Stage stage) {
	 ...
	 * @see Keys */
	public CustomDialog key (final int keycode, final Object object) {
